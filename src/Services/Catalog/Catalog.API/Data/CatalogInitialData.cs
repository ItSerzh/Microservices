...
public class CatalogInitialData : IInitialData
{
    ...
    private IEnumerable<Product> GetInitialProducts() =>
    [
        new()
        {
            ...
            Price = 950.00M,
            Categeories = new List<string> { "Smart Phone" }
        },
        new ()
        {
        ...
        new ()
        {
            ...
            Price = 650.00M,
            Categeories = new List<string> { "White Appliances" }
        },
        new ()
        {
        ...
        new ()
        {
            ...
            Price = 240.00M,
            Categeories = new List<string> { "Home Kitchen" }
        },
        new ()
        {
            ...
            ImageFile = "product-6.png",
            Price = 240.00M,
            Categeories = new List<string> { "Camera" }
        }
    ];
}
